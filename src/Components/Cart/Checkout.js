...
import order from "../../Assets/delivery.png"
...
const Checkout = () => {
 ...
 const isLogin = useSelector((state) => state.user.isLogin)
  return (
   ...
   {isLogin ? 
   <div className="bg-slate-100 p-8 rounded shadow-md min-h-screen  flex justify-between items-center flex-col md:flex-row">
